...
try:
    ...
    # print(c)
    l = []
    # If you want to add more operator youn can use that as well
    o = list("+-*/")
    o1 = []
    r = []
    ...
    o1 = list(set(o1))
    # print(o1)
    # if you use li=l then it may occures some un usual error further in program.
    li = copy.deepcopy(l)
    for x in o1:
        if (x in li):
            li.remove(x)
